require sunxi-mali-mainline.inc
...
do_install() {
    ...
    install -m 0644 ${S}/include/${MALI_INC_DIR}/EGL/*.h ${D}${includedir}/EGL/
    install -d -m 0755 ${D}${includedir}/GLES
    install -m 0644 ${S}/include/${MALI_INC_DIR}/GLES/*.h ${D}${includedir}/GLES/
